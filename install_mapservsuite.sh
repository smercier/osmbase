...
sudo apt-get -y install postgis postgresql-9.1 \
      postgresql-server-dev-9.1 postgresql-contrib-9.1 \
      postgis gdal-bin binutils libgeos-3.2.2 libgeos-c1 \
      ...
      mapcache-tools libapache2-mod-mapcache tinyows
